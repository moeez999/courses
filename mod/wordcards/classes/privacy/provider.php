...
class provider implements
    ...
    public static function _get_metadata(collection $collection) {
        ...
        $collection->add_database_table(constants::M_ATTEMPTSTABLE, $attemptdetails, 'privacy:metadata:attempttable');
    ...
    public static function delete_data_for_users(approved_userlist $userlist) {
        ...
        $attemptswhere = "modid = :instanceid AND userid {$userinsql}";
        ...
        $deletewhere = "modid = :instanceid AND userid {$userinsql}";
