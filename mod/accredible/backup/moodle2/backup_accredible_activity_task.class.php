...
/**
 * Class to make backup for Accredible activiy.
 *
...
class backup_accredible_activity_task extends backup_activity_task {
    ...
    public static function encode_content_links($content) {
        ...
        // Link to accredible view by moduleid.
        $search = "/(" . $base . "\/mod\/accredible\/view.php\?id\=)([0-9]+)/";
        $content = preg_replace($search, '$@ACCREDIBLEVIEWBYID*$2@$', $content);
