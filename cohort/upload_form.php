...
class cohort_upload_form extends moodleform {
    ...
    protected function process_upload_file($file, $encoding, $delimiter, $defaultcontext) {
        ...
        $allowedcolumns = array('contextid', 'name', 'shortname', 'idnumber', 'description', 'descriptionformat', 'enabled', 'visible', 'theme', 'cohortmonday', 'cohorttuesday', 'cohortwednesday', 'cohortthursday', 'cohortfriday', 'cohorthours', 'cohortminutes', 'cohorttutormonday', 'cohorttutortuesday', 'cohorttutorwednesday', 'cohorttutorthursday', 'cohorttutorfriday', 'cohorttutorhours', 'cohorttutorminutes');
