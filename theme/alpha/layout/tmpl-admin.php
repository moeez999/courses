...
<div id="subscribeModal" class="modal">
  <div class="modal-content">
    ...
    <ul class="user-list">
      <li>
        <img src="https://randomuser.me/api/portraits/men/1.jpg" alt="Wade Warren" />
        <div>
          <strong>Wade Warren</strong> · English<br />
          <span>Trial lesson completed</span>
        </div>
        <button class="subscribe-btn">Subscribe</button>
      </li>
      <li>
        <img src="https://randomuser.me/api/portraits/women/2.jpg" alt="Camila" />
        <div>
          <strong>Camila</strong> · English<br />
          <span>Trial lesson completed</span>
        </div>
        <button class="subscribe-btn">Subscribe</button>
      </li>
      <li>
        <img src="https://randomuser.me/api/portraits/women/3.jpg" alt="Karen" />
        <div>
          <strong>Karen</strong> · English<br />
          <span>Subscription cancelled</span>
        </div>
        <button class="subscribe-btn">Subscribe</button>
      </li>
    </ul>
    <div class="transfer-lessons">
      🔁 <a href="#">Transfer lessons or subscription</a>
    </div>
  </div>
</div>
