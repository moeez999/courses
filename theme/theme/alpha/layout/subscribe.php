...
<div class="what-would-you-like-to-do-modal custom-modal" id="what-would-you-like-to-do-modal">
...
<div class="what-would-you-like-to-do-modal transfer-to-modal custom-modal" id="transfer-to-modal">
    <div class="backIcon backIcon-two back-modal">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path fill-rule="evenodd" clip-rule="evenodd"
                d="M3.91406 8.9932L15.9141 8.9932L15.9141 6.99319L3.91406 6.9932L9.20706 1.7002L7.79306 0.286195L0.0860627 7.9932L7.79306 15.7002L9.20706 14.2862L3.91406 8.9932Z"
                fill="#121117"></path>
    ...
    <div class="closeIcon closeIcon-three backdrop-level-2-close">
        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 13 13" fill="none">
            <path fill-rule="evenodd" clip-rule="evenodd"
                d="M1.414 0L0 1.414L4.95 6.364L0 11.314L1.414 12.728L6.364 7.778L11.314 12.728L12.728 11.314L7.778 6.364L12.728 1.414L11.314 0L6.364 4.95L1.414 0Z"
                fill="#121117"></path>
        ...
        <ul>
            ...
            <li class="how-many-lessons-you-want-modal-open">
                <div class="leftSide">
                    ...
                    <div class="content">
                        <h3>Karen V.</h3>
                        <p>8 lessons left · $3 per lesson</p>
                    </div>
                </div>
                <div class="rightArrow">
                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="16" viewBox="0 0 10 16" fill="none">
...
<div class="what-would-you-like-to-do-modal how-many-lessons-you-want-modal custom-modal"
    ...
    <div class="backIcon   backIcon-three back-modal">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path fill-rule="evenodd" clip-rule="evenodd"
                d="M3.91406 8.9932L15.9141 8.9932L15.9141 6.99319L3.91406 6.9932L9.20706 1.7002L7.79306 0.286195L0.0860627 7.9932L7.79306 15.7002L9.20706 14.2862L3.91406 8.9932Z"
                fill="#121117"></path>
    ...
    <div class="container">
        ...
        <a href="#" class="btn review-your-transfer-modal-open" id="review-your-transfer-modal-open">Continue</a>
    </div>
</div>
...
<div class="what-would-you-like-to-do-modal how-many-lessons-you-want-modal review-your-transfer-modal custom-modal"
    id="review-your-transfer-modal">
    <div class="backIcon backIcon-six back-modal">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path fill-rule="evenodd" clip-rule="evenodd"
                d="M3.91406 8.9932L15.9141 8.9932L15.9141 6.99319L3.91406 6.9932L9.20706 1.7002L7.79306 0.286195L0.0860627 7.9932L7.79306 15.7002L9.20706 14.2862L3.91406 8.9932Z"
                fill="#121117"></path>
    ...
    <div class="container">
        <div class="row">
            ...
            <span><strong>$29.44</strong></span>
        </div>
        <div class="row">
            <span>5 lessons with Daniela</span>
            <span><strong>$24.84</strong></span>
        </div>
    </div>
    ...
    <div class="balance-box">
        <div class="row">
            ...
            <span>
                <strong class="extra-price">-$2.76</strong>
            </span>
        </div>
    </div>
    ...
    <button class="btn transfer-complete-modal-Open" id="transfer-complete-modal-open">Transfer Complete</button>
</div>
<div class="what-would-you-like-to-do-modal transferComplete transfer-complete-modal custom-modal"
    id="transfer-complete-modal">
    ...
    <div class="bottomPart">
        <div class="paragraphs">
            <p>
                Nice! You have 1 lesson with Daniela, and a $2.39 Preply credit for
                your future payments.
            </p>
            <p>Now it's time to schedule your lesson.</p>
        </div>

        <div class="btns">
            <button class="btn backdrop-level-2-close close-eight">Schedule lesson</button>
            <button class="btn backdrop-level-2-close close-eight">I'll do it later</button>
        </div>
    </div>
</div>
...
<div class="what-would-you-like-to-do-modal transfer-remaining-balance-transfer-to custom-modal"
    ...
    <div class="backIcon backIcon-nine back-modal">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path fill-rule="evenodd" clip-rule="evenodd"
                d="M3.91406 8.9932L15.9141 8.9932L15.9141 6.99319L3.91406 6.9932L9.20706 1.7002L7.79306 0.286195L0.0860627 7.9932L7.79306 15.7002L9.20706 14.2862L3.91406 8.9932Z"
                fill="#121117"></path>
    ...
    <div class="recommendedContainer">
        <div class="tutors-info-container">
            <div class="tutor-profile">
                ...
                <div class="tutor-profile-content">
                    <div class="name-country">
                        ...
                        <img src="../img/subs/flag/1.png" alt="">
                    </div>
            ...
            <div class="btns">
                <button class="btn choose-your-trial-lesson-duration-modal-open"
                    id="choose-your-trial-lesson-duration-modal-open">
            ...
            <div class="tutor-profile">
                ...
                <div class="tutor-profile-content">
                    <div class="name-country">
                        ...
                        <img src="../img/subs/flag/2.png" alt="">
                    </div>
                    <div class="rate-amount">
                        <div class="leftSide">
                            <div class="rating">
            ...
            <div class="tutor-profile">
                ...
                <div class="tutor-profile-content">
                    <div class="name-country">
                        ...
                        <img src="../img/subs/flag/3.png" alt="">
                    </div>
                    <div class="rate-amount">
                        <div class="leftSide">
                            <div class="rating">
    ...
    <div class="exploreTutorContainer">
        <div class="exploreTutorContent">
            ...
            <button class="transfer-complete-modal-open-v1">
                Explore tutors
            </button>
        </div>
    </div>
...
<div class="what-would-you-like-to-do-modal choose-your-trial-lesson-duration-modal custom-modal"
    ...
    <div class="backIcon backIcon-ten back-modal">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path fill-rule="evenodd" clip-rule="evenodd"
                d="M3.91406 8.9932L15.9141 8.9932L15.9141 6.99319L3.91406 6.9932L9.20706 1.7002L7.79306 0.286195L0.0860627 7.9932L7.79306 15.7002L9.20706 14.2862L3.91406 8.9932Z"
                fill="#121117"></path>
    ...
    <h1>Choose your trial lesson duration</h1>

    <div class="trialContainer">
        <div class="trial review-your-transfer-modal-open">
            <div class="leftSide">
                <img src="../img/subs/icons/Vector.png" alt="">
        ...
        <div class="trial review-your-transfer-modal-open">
            <div class="leftSide">
                <img src="../img/subs/icons/image.png" alt="">
...
<div class="balance-modal custom-modal" id="balanceModal">
    <div class="topPart">
        ...
        <div class="teacherBox">
            <div class="imageContainer">
                <img src="../img/subs/13.png" alt="">
            </div>
            <p>Albert : 1</p>
        </div>
        <div class="teacherBox">
            <div class="imageContainer">
                <img src="../img/subs/19.png" alt="">
            </div>
            <p>Daniela : 0</p>
        </div>
        <div class="teacherBox">
...
<div class="what-would-you-like-to-do-modal how-many-lessons-you-want-modal why-need-to-transfer-subscription-modal custom-modal"
    ...
    <ul>
        <li class="transfer-subscription-review-transfer-modal-open">
            <div class="leftSide">
                <img src="../img/subs/icons/garbage.png" alt="">
        ...
        <li class="transfer-subscription-review-transfer-modal-open">
            <div class="leftSide">
                <img src="../img/subs/icons/time.png" alt="">
        ...
        <li class="transfer-subscription-review-transfer-modal-open">
            <div class="leftSide">
                <img src="../img/subs/icons/calender.png" alt="">
        ...
        <li class="transfer-subscription-review-transfer-modal-open">
            <div class="leftSide">
                <img src="../img/subs/icons/expensive.png" alt="">
        ...
        <li class="transfer-subscription-review-transfer-modal-open">
            <div class="leftSide">
                <img src="../img/subs/icons/doNotLike.png" alt="">
        ...
        <li class="transfer-subscription-review-transfer-modal-open">
            <div class="leftSide">
                <img src="../img/subs/icons/outside.png" alt="">
        ...
        <li class="transfer-subscription-review-transfer-modal-open">
            <div class="leftSide">
                <img src="../img/subs/icons/menu.png" alt="">
