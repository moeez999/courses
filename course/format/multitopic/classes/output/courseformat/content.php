...
class content extends content_base {
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        // if (!empty($tabseft->secondrow->tabs) && isset($tabseft->secondrow->tabs[0])) {
        //     $tabseft->secondrow->tabs[0]->text = 'Topic';
        // }
        
        if (!empty($tabseft->secondrow->tabs) && isset($tabseft->secondrow->tabs[0])) {
            $tempTab = clone $tabseft->secondrow->tabs[0];

            //$tempTab = $tabseft->secondrow->tabs[0]; // Save the first element in a temporary variable
            array_shift($tabseft->secondrow->tabs); // Remove the first element
        }
