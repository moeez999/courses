...
class __Mustache_db7c806793ebce5fc56273ed213f2728 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '<footer style="display: none;" id="s-page-footer" class="wrapper-page ';
...
';
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '        <div class="rui-footer-wrapper w-100 text-center text-lg-left">
';
        $buffer .= $indent . '            <ul class="rui-footer--contact">
';
        $value = $context->find('website');
        $buffer .= $this->section05ed97e5c2be2a24f3e5b030ae9606a9($context, $indent, $value);
...
';
        ...
        $buffer .= $this->section1c6edfa5c60481e41636ed04548a1d99($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
        ...
        $buffer .= $this->sectionD4e1bfde7f95586b5d367f7320af80c7($context, $indent, $value);
...
';
        ...
        $buffer .= $this->sectionCad744d3a03151712d7140388bb4cfce($context, $indent, $value);
...
';
        ...
        $buffer .= $this->section11ef24ed4cde8be22c863ff4b8f29459($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . ' 
';
...
';
    ...
    private function section05ed97e5c2be2a24f3e5b030ae9606a9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionF476947ce1bde677e03c22a64b31b107(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section930216d2b50d5fad85287388aded86cb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section9494c7505f2c652b503bdcb116a814e7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '                    <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><path d="M19.039,19.043H16.078V14.4c0-1.106-.023-2.53-1.544-2.53-1.544,0-1.78,1.2-1.78,2.449v4.722H9.792V9.5h2.845v1.3h.039a3.12,3.12,0,0,1,2.808-1.542c3,0,3.556,1.975,3.556,4.546v5.238ZM6.447,8.194A1.72,1.72,0,1,1,8.168,6.473,1.719,1.719,0,0,1,6.447,8.194ZM7.932,19.043H4.963V9.5H7.932ZM20.521,2H3.476A1.458,1.458,0,0,0,2,3.441V20.559A1.458,1.458,0,0,0,3.476,22H20.518A1.463,1.463,0,0,0,22,20.559V3.441A1.464,1.464,0,0,0,20.518,2Z" fill="currentColor"/></svg>
';
                $buffer .= $indent . '                </a>
';
                $buffer .= $indent . '                </li>
';
    ...
    private function sectionA692df92b48347e8b44b9900cb7db16b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionA30fc672e7cf5d0d1c477351a75e1547(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section1c6edfa5c60481e41636ed04548a1d99(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="rui-footer-wrapper w-100 {{#isfrontpage}}text-center{{/isfrontpage}}">
        <ul class="rui-footer--social {{#isfrontpage}}d-flex justify-content-center{{/isfrontpage}}">
            {{#facebook}}
                <li>
                <a href="{{facebook}}" target="_blank" class="facebook">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="rui-footer-wrapper w-100 ';
                $value = $context->find('isfrontpage');
                $buffer .= $this->sectionD48c49af31da8c58ebf1b33f5bb1ae89($context, $indent, $value);
                $buffer .= '">
';
...
';
                ...
                $buffer .= $this->sectionF476947ce1bde677e03c22a64b31b107($context, $indent, $value);
                $buffer .= $indent . '
';
                $value = $context->find('twitter');
                $buffer .= $this->section930216d2b50d5fad85287388aded86cb($context, $indent, $value);
                $buffer .= $indent . '
';
                $value = $context->find('linkedin');
                $buffer .= $this->section9494c7505f2c652b503bdcb116a814e7($context, $indent, $value);
                $buffer .= $indent . '
';
                $value = $context->find('youtube');
                $buffer .= $this->sectionA692df92b48347e8b44b9900cb7db16b($context, $indent, $value);
                $buffer .= $indent . '
';
                $value = $context->find('instagram');
                $buffer .= $this->sectionA30fc672e7cf5d0d1c477351a75e1547($context, $indent, $value);
                $buffer .= $indent . '
';
...
';
    ...
    private function sectionD4e1bfde7f95586b5d367f7320af80c7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="rui-footer-wrapper mt-3 text-center text-lg-left">
                ...
                <div class="rui-debug rui-footer-btns footer-content-debugging w-100 d-block mt-4 small">{{{ output.debug_footer_html }}}</div>
        </div>
        ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="rui-footer-wrapper mt-3 text-center text-lg-left">
';
...
';
                ...
                $buffer .= '</div>
';
                $buffer .= $indent . '                <div class="rui-debug rui-footer-btns footer-content-debugging w-100 d-block mt-4 small">';
...
';
    ...
    private function sectionCad744d3a03151712d7140388bb4cfce(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
    <div class="rui-custom-alert rui-custom-alert--light alert alert-dismissible {{#closecustomalert}}hide_alert{{/closecustomalert}}" role="alert">
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '    <div class="rui-custom-alert rui-custom-alert--light alert alert-dismissible ';
                $value = $context->find('closecustomalert');
...
';
    ...
    private function section11ef24ed4cde8be22c863ff4b8f29459(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '            if (txtValue.toUpperCase().indexOf(filter) > -1) {
';
