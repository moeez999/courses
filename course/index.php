...
<section class="resubscribe-modal">
    ...
    <div class="modal-content-resubscribe">
        ...
        <div class="plan-summary">
            ...
            <button class="change-plan-button subscribe-modal-open-teacher">Change plan</button>
        </div>
...
<?php // 1️⃣ Check if the user has the "student" role in Moodle.
   ...
   require_once('./Modals/teacherSubscription.php');
     require_once('./Modals/groupSubscription.php');
        require_once('./Modals/groupModal.php');
            require_once('./Modals/cancelGroupSubscriptionModal.php');
                require_once('./Modals/cancelTeacherSubscriptionModal.php');
