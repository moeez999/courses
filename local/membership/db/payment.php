...
(function() {
    ...
    if (!checkoutPage && signupPage) {
        ...
        function initCheckout() {
            ...
            <label class="cursor-pointer user-select-none  m-0"><input type="checkbox" id="consent-checkbox">Acepto los <a href="https://latingles.com/terminos-y-condiciones/" class="web-content">términos y condiciones</a>, <a href="https://latingles.com/politica-de-privacidad/" class="web-content">política de privacidad</a> y SMS relacionado a mis clases.</label>
