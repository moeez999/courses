  ...
  $(document)
    ...
    .on("drop", ".day-inner", function (e) {
      ...
      if (isOne2One) {
        ...
        apiUrl = M.cfg.wwwroot + "/local/customplugin/ajax/update_one2one.php";
        ...
        const formattedDate = newDate; // Already in YYYY-MM-DD format

        payload = {
          data: {
            teacher: { id: teacherId },
            student: { id: studentId },
            cmid: googlemeetId || $event.data("cm-id"),
    ...
    try {
      ...
      for (let i = 0; i < allEvents.length; i++) {
        ...
        const eventObj = {
          ...
          previousTeacherPic:
            ev.previousTeacherPic ||
            ev.rescheduled?.previous_teacher_picture ||
            null,
          previous_teacher_picture:
            ev.previous_teacher_picture ||
            ev.rescheduled?.previous_teacher_picture ||
            null,
        };
