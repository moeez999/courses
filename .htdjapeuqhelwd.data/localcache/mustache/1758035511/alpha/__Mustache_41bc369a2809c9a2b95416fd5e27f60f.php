...
class __Mustache_41bc369a2809c9a2b95416fd5e27f60f extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '                     <li class="nav-item subscribe subscribe-modal-open" id="add_new_item">
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '                     <li class="nav-item balance subscribe balance-modal-open">
';
