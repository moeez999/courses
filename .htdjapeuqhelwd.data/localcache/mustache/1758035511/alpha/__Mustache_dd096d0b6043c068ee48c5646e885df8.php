...
class __Mustache_dd096d0b6043c068ee48c5646e885df8 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="form-group row px-0 mb-2 ';
        ...
        $buffer .= '">
';
        $buffer .= $indent . '    <div class="col-md-3 text-md-right mb-sm-1 mb-md-0">
';
