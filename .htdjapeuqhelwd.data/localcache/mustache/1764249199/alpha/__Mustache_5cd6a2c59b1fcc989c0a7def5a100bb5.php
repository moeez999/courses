...
class __Mustache_5cd6a2c59b1fcc989c0a7def5a100bb5 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                            <div style="margin-top:10%;">
';
        $buffer .= $indent . '                            <a href="/courses/local/refer-a-friend" style="background: rgba(255, 255, 255, 1);border: 2.33px solid rgba(220, 220, 229, 1);padding: 9px 19.5px;border-radius: 9.33px;justify-content: center;align-items: center;font-weight: 500;font-size: 14px;line-height: 21px;color: rgba(0, 0, 0, 1);text-transform: capitalize;
';
...
';
        $buffer .= $indent . '      <ul style="display:flex;align-items:center;gap:18px;margin:0;padding:0;list-style:none;overflow-x:auto;">
';
...
';
        ...
        $value = $this->resolveValue($context->findDot('config.wwwroot'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '/local/customplugin/my_students.php"
';
        $buffer .= $indent . '             data-role="alpha2-nav-link"
';
        $buffer .= $indent . '             style="display:inline-flex;align-items:center;width:max-content;
...
';
        ...
        $value = $this->resolveValue($context->findDot('config.wwwroot'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '/local/customplugin/my_students_details_lessons_plans.php"
';
        $buffer .= $indent . '             data-role="alpha2-nav-link"
';
        $buffer .= $indent . '             style="display:inline-flex;align-items:center;width:max-content;
...
';
        ...
        $value = $this->resolveValue($context->findDot('config.wwwroot'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '/local/customplugin/my_settings.php"
';
        $buffer .= $indent . '             data-role="alpha2-nav-link"
';
        $buffer .= $indent . '             style="display:inline-flex;align-items:center;width:max-content;
...
';
        ...
        $value = $this->resolveValue($context->findDot('config.wwwroot'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '/local/customplugin/my_teachers.php"
';
        $buffer .= $indent . '             data-role="alpha2-nav-link"
';
        $buffer .= $indent . '             style="display:inline-flex;align-items:center;width:max-content;
...
';
        ...
        $value = $this->resolveValue($context->findDot('config.wwwroot'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '/local/customplugin/teacher_settings_profile.php"
';
        $buffer .= $indent . '             data-role="alpha2-nav-link"
';
        $buffer .= $indent . '             style="display:inline-flex;align-items:center;width:max-content;
...
';
        $buffer .= $indent . '                    color:#111;border-bottom:2px solid transparent;">
';
        $buffer .= $indent . '           Teacher Admin Settings
';
        $buffer .= $indent . '          </a>
';
        $buffer .= $indent . '        </li>
...
';
        ...
        $value = $this->resolveValue($context->findDot('config.wwwroot'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '/local/customplugin/find_groups.php"
';
        $buffer .= $indent . '           style="display:inline-flex;align-items:center;justify-content:center;
';
        $buffer .= $indent . '                  padding:10px 18px;border-radius:10px;background:#fff;
