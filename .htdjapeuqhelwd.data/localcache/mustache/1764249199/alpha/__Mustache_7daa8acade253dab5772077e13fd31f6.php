...
class __Mustache_7daa8acade253dab5772077e13fd31f6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section7347a433352d09ce66504ad237daafc8($context, $indent, $value);
        $value = $context->find('component');
        if (empty($value)) {
...
';
    ...
    private function section7347a433352d09ce66504ad237daafc8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<span class="d-inline-flex inplaceeditable inplaceeditable-{{type}}" data-inplaceeditable="1" data-component="{{component}}" data-itemtype="{{itemtype}}" data-itemid="{{itemid}}"
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<span class="d-inline-flex inplaceeditable inplaceeditable-';
