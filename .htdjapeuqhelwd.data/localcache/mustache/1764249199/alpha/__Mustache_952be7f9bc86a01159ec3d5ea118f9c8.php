...
class __Mustache_952be7f9bc86a01159ec3d5ea118f9c8 extends Mustache_Template
{
...
';
        ...
        if (is_callable($blockFunction)) {
            ...
            $buffer .= $this->section32da425d2a871bfd266fad06b275847f($context, $indent, $value);
        }
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</div>
';
    ...
    private function section32da425d2a871bfd266fad06b275847f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
