...
class __Mustache_22e7a07d23a5970e61facb664cf3b139 extends Mustache_Template
{
...
';
        $buffer .= $indent . '            style="background:#fff;border:2.33px solid rgba(220,220,229,1);
';
        $buffer .= $indent . '                   padding:6px 12px;border-radius:9999px;
';
        $buffer .= $indent . '                   display:flex;align-items:center;gap:8px;">
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '        <img
