...
class __Mustache_79bbe57eb20b51849df5eedb6d6a8956 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <button class="profile-role__btn"
';
...
';
        $buffer .= $indent . '            padding: 9px 19.5px;
';
...
';
        $buffer .= $indent . '            style="width:28px;height:28px;border-radius:50%;object-fit:cover;"
';
        $buffer .= $indent . '        />
';
        $buffer .= $indent . '
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '        <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
';
