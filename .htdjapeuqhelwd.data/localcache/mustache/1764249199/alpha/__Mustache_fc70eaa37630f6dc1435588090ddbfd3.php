...
class __Mustache_fc70eaa37630f6dc1435588090ddbfd3 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '        <span class="dropdown-arrow" style="margin-left: auto; color: beige;">
';
        $buffer .= $indent . '          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
';
...
';
        $buffer .= $indent . '                            <a href="#" id="openBalance" style="background: rgba(255, 255, 255, 1);border: 2.33px solid rgba(220, 220, 229, 1);padding: 9px 19.5px;border-radius: 9.33px;justify-content: center;align-items: center;font-weight: 500;font-size: 14px;line-height: 21px;color: rgba(0, 0, 0, 1);text-transform: capitalize;">Balance: 0</a>
';
        $buffer .= $indent . '                            <div>
';
        $buffer .= $indent . '                     </li>
