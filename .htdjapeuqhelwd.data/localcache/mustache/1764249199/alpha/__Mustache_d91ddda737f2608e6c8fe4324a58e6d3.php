...
class __Mustache_d91ddda737f2608e6c8fe4324a58e6d3 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section56f0c5848b6386df45ce905570e99760($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
        $value = $context->find('topbarlogoareaon');
        $buffer .= $this->sectionC84baa7e0b6a416e70069c001298e183($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
        $value = $context->findDot('output.custom_menu');
        $buffer .= $this->section1193f37e847d7a90cfa927c518a4e368($context, $indent, $value);
        $buffer .= $indent . '
';
        $value = $context->find('topbarcustomhtml');
        $buffer .= $this->section1824fffd6ad504491872a118ba1c26f3($context, $indent, $value);
        ...
        $buffer .= '">
';
        $buffer .= $indent . '<li class="nav-item profile-role">
';
        $buffer .= $indent . '    <button id="openProfileRoleDropdown" class="profile-role__btn"
';
...
';
        $buffer .= $indent . '            style="
';
        $buffer .= $indent . '            background: rgba(255, 255, 255, 1);
';
        $buffer .= $indent . '            border: 2.33px solid rgba(220, 220, 229, 1);
';
        $buffer .= $indent . '            padding: 9px 9.5px;
';
        $buffer .= $indent . '            border-radius: 9.33px;
';
...
';
        $buffer .= $indent . '            line-height: 21px;
';
        $buffer .= $indent . '            color: rgba(0, 0, 0, 1);
';
...
';
        $buffer .= $indent . '            src="';
        $value = $context->find('useravatar');
        $buffer .= $this->sectionE698e2a7fe6df647017bfa075094ee76($context, $indent, $value);
        $value = $context->find('useravatar');
        if (empty($value)) {
            
            $buffer .= 'https://i.pravatar.cc/40';
        }
        $buffer .= '"
';
        $buffer .= $indent . '            alt="User avatar"
';
        $buffer .= $indent . '            style="width:23px;height:23px;border-radius:50%;object-fit:cover;"
';
        $buffer .= $indent . '        />
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '        <span style="font-weight:500;font-size:14px;">
';
        $buffer .= $indent . '            ';
        $value = $context->find('userrole');
        $buffer .= $this->section41850ef7abdfba3c425d14a43c5ffdcd($context, $indent, $value);
        $value = $context->find('userrole');
        if (empty($value)) {
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
';
        $buffer .= $indent . '             stroke="currentColor" stroke-width="2">
';
        $buffer .= $indent . '            <polyline points="6 9 12 15 18 9"></polyline>
';
        $buffer .= $indent . '        </svg>
';
        $buffer .= $indent . '    </button>
...
';
        $buffer .= $indent . '                            <a href="#" id="openBalance" style="background: rgba(255, 255, 255, 1);border: 2.33px solid rgba(220, 220, 229, 1);padding: 9px 19.5px;border-radius: 9.33px;justify-content: center;align-items: center;font-weight: 500;font-size: 14px;line-height: 21px;color: rgba(0, 0, 0, 1);text-transform: capitalize;
';
...
';
        $buffer .= $indent . '                            <div style="margin-top:10%;">
';
        $buffer .= $indent . '                            <a href="/courses/local/refer-a-friend/index.php" style="background: rgba(255, 255, 255, 1);border: 2.33px solid rgba(220, 220, 229, 1);padding: 9px 19.5px;border-radius: 9.33px;justify-content: center;align-items: center;font-weight: 500;font-size: 14px;line-height: 21px;color: rgba(0, 0, 0, 1);text-transform: capitalize;
';
...
';
        ...
        $buffer .= $this->section6bd82315c2a52204633040e0fa075a0d($context, $indent, $value);
        $buffer .= $indent . '                <li>';
...
';
        $buffer .= $indent . '      display:flex;align-items:center;justify-content:space-between;gap:10px;
';
...
';
        $buffer .= $indent . '      <ul class="nav-item-scroll" style="display:flex;align-items:center;gap:18px;margin:0;padding:0;list-style:none;overflow-x:auto;">
';
...
';
        $buffer .= $indent . '             style="display:inline-flex;align-items:center;width:max-content;
';
...
';
        $buffer .= $indent . '                    color:#111;border-bottom:2px solid transparent;">
';
        $buffer .= $indent . '           Teacher Settings
';
        $buffer .= $indent . '          </a>
';
        $buffer .= $indent . '        </li>
...
';
        ...
        $value = $this->resolveValue($context->findDot('config.wwwroot'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '/local/customplugin/my_profile.php"
';
        $buffer .= $indent . '             data-role="alpha2-nav-link"
';
        $buffer .= $indent . '             style="display:inline-flex;align-items:center;width:max-content;
...
';
        ...
        $value = $this->resolveValue($context->findDot('config.wwwroot'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '/local/customplugin/my_profile_settings.php"
';
        $buffer .= $indent . '             data-role="alpha2-nav-link"
';
        $buffer .= $indent . '             style="display:inline-flex;align-items:center;width:max-content;
...
';
        $buffer .= $indent . '                    color:#111;border-bottom:2px solid transparent;">
';
        $buffer .= $indent . '           Student Settings
';
        $buffer .= $indent . '          </a>
';
        $buffer .= $indent . '        </li>
...
';
        ...
        $value = $this->resolveValue($context->findDot('config.wwwroot'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '/local/customplugin/one_and_one_class.php"
';
        $buffer .= $indent . '             data-role="alpha2-nav-link"
';
        $buffer .= $indent . '             style="display:inline-flex;align-items:center;width:max-content;
...
';
        $buffer .= $indent . '<style>
';
        $buffer .= $indent . '.nav-item-scroll::-webkit-scrollbar {
';
        $buffer .= $indent . '    width: 0px;
';
...
';
    ...
    private function sectionBa6174b3a147dab9e51a4aa77fb0f5dc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section56f0c5848b6386df45ce905570e99760(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionBa6174b3a147dab9e51a4aa77fb0f5dc($context, $indent, $value);
                $buffer .= $indent . '
';
                $value = $context->find('customlogo');
                if (empty($value)) {
...
';
    ...
    private function sectionC8272836b8648bb2c47bf22b2dbf74aa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionC84baa7e0b6a416e70069c001298e183(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $value = $context->find('customlogo');
                $buffer .= $this->sectionC8272836b8648bb2c47bf22b2dbf74aa($context, $indent, $value);
                $buffer .= $indent . '
';
                $value = $context->find('customlogo');
                if (empty($value)) {
...
';
    ...
    private function section106b31728a98012655c5b3ffd1f506a6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section1193f37e847d7a90cfa927c518a4e368(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section106b31728a98012655c5b3ffd1f506a6($context, $indent, $value);
                $context->pop();
            }
        }
    ...
    private function section1824fffd6ad504491872a118ba1c26f3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionE698e2a7fe6df647017bfa075094ee76(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('useravatar'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $context->pop();
            }
        }
    ...
    private function section41850ef7abdfba3c425d14a43c5ffdcd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('userrole'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $context->pop();
            }
        }
    ...
    private function section6bd82315c2a52204633040e0fa075a0d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
