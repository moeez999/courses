...
class __Mustache_ffecf99f56072acb0a77af906022400d extends Mustache_Template
{
...
';
        ...
        $buffer .= $indent . '            <style>
';
        $buffer .= $indent . '              .rui-navbar-btn {
';
        $buffer .= $indent . '                min-width: 120px;
';
...
';
        $buffer .= $indent . '    <button id="openProfileRoleDropdown" class="profile-role__btn rui-navbar-btn"
';
...
';
        $buffer .= $indent . '                        <button id="openModal" class="subscribe-nav-btn rui-navbar-btn">Subscribe</button>
';
        $buffer .= $indent . '                     </li>
';
        $buffer .= $indent . '
...
';
        $buffer .= $indent . '                            <a href="#" id="openBalance" class="rui-navbar-btn">Balance: 0</a>
';
        $buffer .= $indent . '                            <div>
';
        $buffer .= $indent . '                     </li>
...
';
        $buffer .= $indent . '                            <div style="margin-top:10%;">
';
        $buffer .= $indent . '                            <a href="/courses/local/refer-a-friend/index.php" class="rui-navbar-btn">Refer friend</a>
';
        $buffer .= $indent . '                            <div>
';
        $buffer .= $indent . '                     </li>
