...
$string['cohortenddate'] = 'End Date';
$string['cohortcolor'] = 'Cohort color';
$string['invalidcolor'] = 'Please enter a valid hex color code (e.g., #00FF00) or color name (e.g., green).';
$string['cohortcolor_help'] = 'Enter a color name (e.g., red) or a hex code (e.g., #FF0000) to visually identify this cohort.';
...
$string['cohortdays'] = 'Course class days';
$string['cohortdays_help'] = 'Select the days of the week with course classes.';
$string['cohorttime'] = 'Course class time';
$string['cohorttime_help'] = 'Specify the time for course classes.';


$string['cohorttutordays'] = 'Tutor days';
$string['cohorttutordays_help'] = 'Select the days of the week with tutor classes.';
$string['cohorttutortime'] = 'Tutor time';
$string['cohorttutortime_help'] = 'Specify the time for tutor classes.';

$string['cohortteacher'] = 'Main/Guide teacher';
$string['cohortteacher_help'] = 'Select the main teacher in the first select, select the guide teacher in the second select.';

$string['cohortstartdate'] = 'Start date';
$string['cohortstartdate_help'] = 'This date determines the start of the cohort.';
