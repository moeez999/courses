...
//------------------------------new
// New strings for the modern profile page
$string['aboutme'] = 'About Me';
$string['results'] = 'Results';
$string['exams'] = 'Exams';
$string['quizzes'] = 'Quizzes';
$string['homework'] = 'Homework';
$string['historycohorts'] = 'History Cohorts';
$string['miscellaneous'] = 'Miscellaneous';
$string['reports'] = 'Reports';
$string['viewallblogentries'] = 'View all blog entries';
$string['notes'] = 'Notes';
$string['mycertificates'] = 'My certificates';
$string['contactinfo'] = 'Contact Information';
$string['loginactivity'] = 'Login Activity';
$string['feedbackgivenbystudent'] = 'Feedback Given By Student';
$string['feedbackgiventostudent'] = 'Feedback Given To Student';
$string['toteacher'] = 'To Teacher';
$string['togroup'] = 'To Group';
$string['byteacher'] = 'By Teacher';
$string['bymanagement'] = 'By Management';
$string['to'] = 'To';
$string['by'] = 'By';
$string['teachername'] = 'Teacher Name';
$string['samplefeedback1'] = 'I noticed great improvement in your recent work, especially in...';
$string['samplefeedback2'] = 'Well done on completing your assignments this week! Your consistency and effort are commendable.';
$string['overallattendance'] = 'Overall Attendance';
$string['mainclass'] = 'Main Class';
$string['practiceclass'] = 'Practice Class';
$string['selectset'] = 'Select Set'; 
$string['nopaymenthistory'] = 'No payment history';
$string['paymenthistory'] = 'Payment Hhistory';
$string['noexams'] = 'No exams';
$string['noquizzes'] = 'No quizzes';
$string['noassignments'] = 'No assignments';
$string['currentcohort'] = 'Current cohort';
