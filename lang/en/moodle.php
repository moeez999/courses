...
$string['courseclassdays'] = 'Course class days';
$string['courseclassdays_help'] = 'Select the days of the week with course classes.';
$string['courseclasstime'] = 'Course class time';
$string['courseclasstime_help'] = 'Specify the time for course classes.';


$string['courseclasstutordays'] = 'Course class tutor days';
$string['courseclasstutordays_help'] = 'Select the days of the week with tutor course classes.';
$string['courseclasstutortime'] = 'Course class tutor time';
$string['courseclasstutortime_help'] = 'Specify the time for tutor course classes.';

$string['courseclassteacher'] = 'Course class main and guide teacher';
$string['courseclassteacher_help'] = 'Select the main teacher in the first select, select the guide teacher in the second select.';
